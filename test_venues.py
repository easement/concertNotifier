...
async def test_all_venues():
    ...
    tasks.append(("The Masquerade", "https://www.masqueradeatlanta.com/events/", test_venue_scraper(scrape_masquerade)))
    ...
    tasks.append(("Helium Comedy Club Atlanta", "https://atlanta.heliumcomedy.com/events", test_venue_scraper(scrape_helium_comedy_atlanta)))
